...
const Dashboard: React.FC = () => {
  const { isDarkMode, getThemeColors, isPrivacyMode } = useTheme();
  ...
  return (
    <div className={`min-h-screen ${bgClass}`}>
      <div className="max-w-6xl mx-auto">
        ...
        {/* Recent Entries */}
        <div className={`${cardClass} rounded-2xl p-6 border relative`}>
          ...
          {isPrivacyMode && (
            <div className="absolute inset-0 bg-gray-900 rounded-2xl flex items-center justify-center z-10">
              <div className="text-center">
                ...
                <h3 className="text-white font-semibold text-lg mb-2">Private Mode Enabled</h3>
                <p className="text-white/90 text-sm max-w-xs">Your journal entries are completely hidden for privacy. Disable in Settings to view content.</p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-4">
              ...
              <div className="mt-6 pt-4 border-t border-white/10">
                <div className="flex justify-center space-x-4">
                  ...
                  >
                    {isPrivacyMode ? 'View Calendar' : 'View All Entries'}
                  </InternalLink>
                  <InternalLink
                    to="/journal"
                    variant="subtle"
